...
namespace
{
    ...
    test_g2r_data_t g2r_data[num_g2r_tests] = {
        ...
        {{"90S", "0E"}, {"89S", "180E"}, {111.20621865770366, 0}},
        {{"90S", "0E"}, {"89S", "135E"}, {111.20621865770366, 45}},
        {{"90S", "0E"}, {"89S", "90E"}, {111.20621865770366, 90}},
        {{"90S", "0E"}, {"89S", "45E"}, {111.20621865770366, 135}},
        {{"90S", "0E"}, {"89S", "0E"}, {111.20621865770366, 180}},
        {{"90S", "0E"}, {"89S", "45W"}, {111.20621865770366, 225}},
        {{"90S", "0E"}, {"89S", "90W"}, {111.20621865770366, 270}},
        {{"90S", "0E"}, {"89S", "135W"}, {111.20621865770366, 315}},
    };
    ...
    //        location_str_t locstr1, locstr2;
    //        radar_t radar;
    //        radar2gis(&locstr1, &radar, &locstr2);
    //        ASSERT_EQ(0, cmpfp(radar.bearing, 0.0, 0.000001)) << "bearing = " << radar.bearing << std::endl;
    //        ASSERT_EQ(0, cmpfp(radar.range, 111.20621865770366, 0.000001)) << "range = " << radar.range << std::endl;
    //    }
} // namespace
